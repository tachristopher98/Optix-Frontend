      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">OPX Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the OPX Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the OPX DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the OPX DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the OPX DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, OPX DApp provides you with the Links and Referral Codes necessary to promote the
                OPX Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the OPX Protocol offers in any manner you choose unless it misleads someone about
                the OPX Protocol.
              </p>
              <p className="body-text">
                2.2 OPX.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the OPX tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                OPX.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the OPX tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall OPX.io be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall OPX.io's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by OPX.io, or your use of the service(s) provided by OPX.io, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from OPX.io, which the token holders of OPX determine. Due to
              ...
              <p className="body-text">
                OPX.io will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                OPX.io may revise these Terms from time to time. We will notify you by updating the date at the top of
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and OPX.io concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. OPX.io will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. OPX.io may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 OPX.io will have no responsibility or liability for any failure or delay in performance of the Site,
