...
export default function BeginAccountTransfer() {
  ...
  const getError = () => {
    ...
    if (hasVestedGmx) {
      return t`Vested OPX not withdrawn`;
    }
    if (hasVestedGlp) {
      return t`Vested OPX not withdrawn`;
    }
    ...
    if (hasStakedGmx || hasStakedGlp) {
      return t`Receiver has staked OPX/OPTIX before`;
    }
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <Trans>
            ...
            <br />
            This will transfer all your OPX, esGMX, OPX, Multiplier Points and voting power to your new account.
            <br />
            Transfers are only supported if the receiving account has not staked OPX or OPX tokens before.
            <br />
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedGmx}>
              <Trans>Sender has withdrawn all tokens from OPX Vesting Vault</Trans>
            </ValidationRow>
              ...
              <>
                ...
                >
                  <span className="text-warning font-sm">
                    <Trans>I do not want to transfer the Affiliate esOPX tokens</Trans>
                  </span>
                </Checkbox>
              </>
            )}
            ...
            <ValidationRow isValid={!hasStakedGmx}>
              <Trans>Receiver has not staked OPX tokens before</Trans>
            </ValidationRow>
