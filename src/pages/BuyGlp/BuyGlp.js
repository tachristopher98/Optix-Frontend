        ...
        subtitle={
          <div>
            {incentiveState?.migration?.isActive && (
              <div>
                <Trans>
                OPX to OPTIX migration has reduced Fees due to STIP incentives.{" "}
            ...
            <Trans>
              Purchase <ExternalLink href="https://docs.gmx.io/docs/providing-liquidity/v1">OPX tokens</ExternalLink> to
