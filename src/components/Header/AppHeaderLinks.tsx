...
import wallet_img from "img/bxs_wallet.svg";
...
export function AppHeaderLinks({ small, openSettings, clickCloseIcon, showRedirectModal }: Props) {
  ...
  return (
    <div className="App-header-links drawer-mobile">
      ...
      <div className="Exchange-swap-button-container mobile-exchange">
        <Button variant="primary-action" className="connect-wallet-btn-drawer" onClick={openConnectModal}>
          <img src={wallet_img} alt="alt"/>
          &nbsp;Connect Wallet
        </Button>
      </div>
